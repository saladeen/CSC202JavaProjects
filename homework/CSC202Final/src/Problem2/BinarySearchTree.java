...
*/
  ...
  // Supports Preorder, Postorder, and Inorder traversal.
  {
    ...
    return new Iterator<T>()
    {
      ...
      /*
      // for some reason the error type isnt resolving
  ...
  public boolean hasSameShape(BinarySearchTree<T> tree) {
    return recShape(root, tree.root);
  }

  public boolean recShape(BSTNode<T> node1, BSTNode<T> node2) {
    if (node1 == null && node2 == null) {
      return true;
    }
    if (node1 != null && node2 != null) {
      return (
        recShape( node1.getLeft(), node2.getLeft() ) && recShape( node1.getRight(), node2.getRight() )
      );
    }
    return false;
  }
