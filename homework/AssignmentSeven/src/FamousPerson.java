...
public class FamousPerson implements Comparable<FamousPerson>
{
  ...
  public static Comparator<FamousPerson> firstNameAlphabeticalComparator() {
    return new Comparator<FamousPerson>() {
      public int compare(FamousPerson element1, FamousPerson element2) {
  ...
  public static Comparator<FamousPerson> lastNameAlphabeticalComparator() {
    return new Comparator<FamousPerson>() {
      public int compare(FamousPerson element1, FamousPerson element2) {
  ...
  public static Comparator<FamousPerson> decreasingYearOfBirthComparator() {
    return new Comparator<FamousPerson>() {
      public int compare(FamousPerson element1, FamousPerson element2) {
